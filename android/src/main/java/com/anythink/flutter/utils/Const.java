...
public class Const {
    ...
    public static String[] initMethodNames = {"setLogEnabled", "setChannelStr", "setSubchannelStr", "setCustomDataDic",
            ...
            "showGDPRAuth", "initAnyThinkSDK", "deniedUploadDeviceInfo","setPresetPlacementConfigPath","showGDPRConsentDialog"};
    ...
    public static String[] splashMethodNames = {"loadSplash", "splashReady", "checkSplashLoadStatus", "getSplashValidAds",
            "showSplash", "showSceneSplash"};
