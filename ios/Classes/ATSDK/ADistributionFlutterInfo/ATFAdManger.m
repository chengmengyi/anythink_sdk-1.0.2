...
- (NSArray *)funcinitNameArray{
    if (_funcinitNameArray == nil) {
        _funcinitNameArray = @[SetLogEnabled,SetChannelStr,SetSubchannelStr,SetCustomDataDic,SetExludeBundleIDArray,SetPlacementCustomData,InitAnyThinkSDK,GetGDPRLevel,GetUserLocation,ShowGDPRAuth, ShowUMPAuth,SetDataConsentSet,SetDeniedUploadInfoArray];
    }
...
- (NSArray *)funcSplashNameArray{
    if (_funcSplashNameArray == nil) {
        _funcSplashNameArray = @[LoadSplashAd,SplashAdReadyReady,CheckSplashAdLoadStatus,ShowSplashAd,ShowSceneSplashAd,GetSplashAdValidAds];
    }
