...
- (UIView*)view{
    ...
    ATBannerView *bannerView = [[ATAdManager sharedManager] retrieveBannerViewForPlacementID:placementID scene:sceneIDStr];
    bannerView.delegate = self.bannerDelegate;
    bannerView.backgroundColor = [UIColor whiteColor];
    bannerView.presentingViewController = [ATFCommonTool getRootViewController];
    NSLog(@"ATFBannerPlatformView-FlutterPlatformView-%@--bannerView:%@",placementID,bannerView);
